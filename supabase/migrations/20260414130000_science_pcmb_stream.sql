-- Grade 11 Science stream: PCMB (Physics, Chemistry, Mathematics, Biology).
-- Distinct slug science_pcmb so PCM/PCB variants can use other stream values later.
...
DELETE FROM public.subjects WHERE grade = 11 AND stream = 'science_pcmb';
...
(
  ...
  3,
  true,
  $${"curriculum_framework":"CBSE Science (Class XI); NCERT Physics","publisher":"National Council of Educational Research and Training","publisher_abbrev":"NCERT","official_textbook_portal":"https://ncert.nic.in/textbook.php","stream":"science_pcmb","volume":1,"primary_textbook":{"series_title":"Physics","part":"Part 1","description":"NCERT Class XI Physics textbook — first volume (units per rationalised syllabus)."},"language_medium":"English","notes":"Confirm unit split between Part 1 and Part 2 on official NCERT PDFs."}$$::jsonb
),
(
  'Physics Part 2',
  11,
...
(
  ...
  5,
  true,
  $${"curriculum_framework":"CBSE Science (Class XI); NCERT Biology","publisher":"National Council of Educational Research and Training","publisher_abbrev":"NCERT","official_textbook_portal":"https://ncert.nic.in/textbook.php","stream":"science_pcmb","primary_textbook":{"series_title":"Biology","subtitle":"Textbook for Class XI","description":"NCERT Class XI Biology (Botany and Zoology themes per syllabus)."},"language_medium":"English"}$$::jsonb
),
(
  'Chemistry Part 1',
  11,
...
(
  ...
  8,
  true,
  $${"curriculum_framework":"CBSE Senior Secondary Stage; NCERT Mathematics (Class XI)","publisher":"National Council of Educational Research and Training","publisher_abbrev":"NCERT","official_textbook_portal":"https://ncert.nic.in/textbook.php","stream":"science_pcmb","primary_textbook":{"series_title":"Mathematics","subtitle":"Textbook for Class XI","description":"NCERT Class XI Mathematics."},"language_medium":"English"}$$::jsonb
);
