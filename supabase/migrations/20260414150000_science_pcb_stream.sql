-- Grade 11 Science stream: PCB (Physics, Chemistry, Biology; no Mathematics).
-- Seven subject rows: duplicate "Biology" in requirements list is merged into one.
...
DELETE FROM public.subjects WHERE grade = 11 AND stream = 'science_pcb';
