...
export default defineConfig({
	...
	projects: [
		...
		// break if a student/parent storageState were preloaded).
		{
			name: "unauth",
			testMatch:
				/(smoke|playwright-env|admin-panel|security-headers|a11y-axe|practice-visuals|visual-snapshots|fixture-gallery-visuals|auth-pages|parent-csrf-gate|landing)\.spec\.ts$/,
		},
		{
			name: "student",
