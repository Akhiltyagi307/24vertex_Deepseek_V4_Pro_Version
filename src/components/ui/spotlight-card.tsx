...
function GlowCard({
  ...
  const style: GlowStyle = {
    ...
    backgroundImage: `radial-gradient(
      ...
      calc(var(--x, 0) * 1px) calc(var(--y, 0) * 1px),
      hsl(var(--hue, 210) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 70) * 1%) / var(--bg-spot-opacity, 0.09)),
      transparent
    )`,
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          "relative grid rounded-2xl p-4 shadow-[0_1rem_2rem_-1rem_black] backdrop-blur-[5px]",
          className
        )}
      >
        <div data-glow />
