					...
					<div className="mt-6 lg:col-span-7">
						<div className="space-y-4 md:space-y-6">
									...
									<Select<string> defaultValue="1">
										...
										>
											<SelectValue placeholder="Select organization">
												{(v) => ORG_LABELS[v as string] ?? "Select organization"}
											</SelectValue>
										</SelectTrigger>
										<SelectContent>
							...
							<div>
								...
								<Select<string> defaultValue="iad1">
									<SelectTrigger id="region" name="region" className="mt-2">
										<SelectValue placeholder="Select region">
											{(v) => REGION_LABELS[v as string] ?? "Select region"}
										</SelectValue>
									</SelectTrigger>
									<SelectContent>
						...
						<Card className="bg-muted">
							<CardContent>
								...
								<p className="mt-2 text-sm leading-6 text-muted-foreground">
									Our flexible plans are designed to scale with your team&apos;s needs.
									All plans include core design collaboration features with varying levels
									of storage and support.
								</p>
