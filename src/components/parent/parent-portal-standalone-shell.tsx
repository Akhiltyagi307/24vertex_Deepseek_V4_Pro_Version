...
const standaloneColumn = "mx-auto w-full min-w-0 md:max-w-[50dvw]";
...
export function ParentPortalStandaloneShell({ children }: ParentPortalStandaloneShellProps) {
	return (
		<div className="relative min-h-svh overflow-x-hidden bg-background px-4 py-8 sm:px-6 sm:py-12">
			<div
				...
				aria-hidden
			/>
			<div className="relative mx-auto flex min-h-[calc(100svh-4rem)] w-full max-w-none flex-col sm:min-h-[calc(100svh-6rem)]">
