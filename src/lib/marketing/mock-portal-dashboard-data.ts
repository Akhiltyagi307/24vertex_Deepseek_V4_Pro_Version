...
export function buildMockTeacherDashboardBundle(): TeacherDashboardBundle {
	const summary: TeacherClassPerformanceSummary = {
		...
		upliftOpportunities: [
			...
			{
				topicId: "mock-topic-optics",
				topicName: "Ray optics",
				subjectName: "Physics",
				averagePercent: 58,
				studentsTested: 22,
				testsTaken: 36,
				studentsBelowSupportLine: 6,
			},
			{
				topicId: "mock-topic-organic",
				topicName: "Organic nomenclature",
				subjectName: "Chemistry",
				averagePercent: 61,
				studentsTested: 20,
				testsTaken: 32,
			...
			{
				topicId: "mock-topic-integration",
			...
			{
				topicId: "mock-topic-genetics",
				topicName: "Mendelian genetics",
				subjectName: "Biology",
				averagePercent: 66,
				studentsTested: 16,
				testsTaken: 24,
