...
export const ADMIN_JWT_ISSUER = "vertex24-admin";
export const ADMIN_JWT_AUDIENCE = "vertex24-admin-panel";

/** @deprecated Accept during transition so existing sessions stay valid. */
export const LEGACY_ADMIN_JWT_ISSUER = "eduai-admin";
export const LEGACY_ADMIN_JWT_AUDIENCE = "eduai-admin-panel";
