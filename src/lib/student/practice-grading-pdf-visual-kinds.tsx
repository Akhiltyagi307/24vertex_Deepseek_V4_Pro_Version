...
import {
	...
	TOKEN,
	indiaMapPdfHeight,
	pdfVisualStyles as styles,
} from "@/lib/student/practice-grading-pdf-visual-tokens";

export function RenderSpec({ visual }: { visual: QuestionVisualEnvelope }): ReactElement {
