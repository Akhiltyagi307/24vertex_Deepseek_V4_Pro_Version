...
> **Product / dashboard chrome (EduAI, Supabase-style)** follows [**design-v2.md**](./design-v2.md) — not Stripe/Dub token values below. Use this file for **marketing**, **landing**, and **inspiration**; use design-v2 for **application UI**.
