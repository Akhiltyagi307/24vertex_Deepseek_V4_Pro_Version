...
> **Supabase Studio / desktop-primary product:** [**design-v2.md**](./design-v2.md) §5 — breakpoints `sm 640` / `md 768` / `lg 1024` / `xl 1280` / `2xl 1536`; sidebar **icon-only ~56px** below `lg`, **200–220px** expanded; `<768px` hamburger/drawer. Main content often stays **~900px+** meaningful width. Use this section for **mobile-first** and **marketing** surfaces that differ from Studio.
