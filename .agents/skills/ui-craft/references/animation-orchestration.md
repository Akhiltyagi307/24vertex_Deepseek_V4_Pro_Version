...
> **Studio-shaped UI:** keep staged sequences within [**design-v2.md**](./design-v2.md) §16 budgets (dropdowns ~**120ms**, modals ~**150ms**, sidebar ~**200ms**). Prefer **opacity + transform**; avoid animating layout. Marketing / hero sequences may exceed Studio timings intentionally.
