...
> **Supabase / EduAI theme layer:** paste or mirror variables from [**design-v2.md**](./design-v2.md) §18 (`:root` / `[data-theme="dark"]` / `[data-theme="light"]`) and Tailwind **§19** — then use techniques below for progressive enhancement.
