...
> **Supabase Studio / EduAI:** tone stays **developer-direct**; errors and destructive copy pair with **`#E55353`** treatment in UI (design-v2 §9, §13.2). Labels and **uppercase mono metrics** follow §3.2 — copy length should fit dense layouts (**13px** body context).
