...
> **Supabase Studio / EduAI chrome:** [**design-v2.md**](./design-v2.md) §7 — keyboard focus ring **`#3ECF8E`**, `outline-offset: 2px`, **`:focus-visible`** only; light theme focus **`#2EB37C`**; contrast pairs table (note `foreground-muted` **not** for primary body text). Radix-style ARIA patterns summarized in §7.3.
...
- Focus visible for keyboard users (`:focus-visible`) — Studio: **2px solid brand green**, never dimmed (design-v2 §7.1)
- Never `tabindex > 0`
