...
> **Supabase Studio**-style apps are almost always **silent**; if you add sound, keep it rare and optional — never conflict with dense, keyboard-first workflows ([**design-v2.md**](./design-v2.md) §7).
